...
class Admin {
    private static final String adminUsername = "Dian";
    private static final String password = "Faradis";
    ...
    public Admin(boolean studentAddPermission) {
        ...
        userStudentList.add(new String[]{"202310370311162", "Dian Faradis", "Teknik", "Informatika"});
    }
...
public class kegiatan2 {
    ...
    public kegiatan2() {
        bookList.put("1234", new String[]{"laskar Pelangi", "Adhidan Obiyansah", "5"});
        bookList.put("5678", new String[]{"Perpustakaan Malam", "Ahmad Habibi", "3"});
    }
